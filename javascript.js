        ...
        // --- 1. CONFIGURACIÓN DEL MOTOR GRÁFICO DEL ESPACIO (CANVAS) ---
...
function resizeCanvas() {
    // Forzamos un tamaño mínimo si el navegador devuelve 0
    ...
    initSpace();
        ...
        // --- 2. CORE DE INTERACCIÓN INTERFAZ (GSAP ENGINE) ---
        ...
        // Giro interactivo de la forma geométrica con la velocidad del cursor
        let lastMouseX = 0;
        window.addEventListener('mousemove', (e) => {
            ...
            gsap.to('.hero-geometry .main-shape', {
                x: moveX, y: moveY, skewX: skewAmount * (moveX > 0 ? 1 : -1),
        ...
        // ==========================================================================
        // SECCIÓN PORTFOLIO SINCRO: CONFIGURACIÓN SCROLLTRIGGER HORIZONTAL
        // ==========================================================================
        const portfolioHorizontal = document.querySelector('.portfolio-horizontal');
        
        // Pin y traslación limpia de la línea de tiempo
        const horizontalTween = gsap.to(portfolioHorizontal, {
            ...
            scrollTrigger: {
                ...
                scrub: 1,
                start: "top top",
                // Duración ajustada al tamaño dinámico real del elemento de flujo
        ...
        document.querySelectorAll('.portfolio-item').forEach(item => {
            ...
            // Rotación interactiva en 3D falsa al entrar al campo de visión del visor
            gsap.fromTo(screen, 
                ...
                { 
                    ...
                    scrollTrigger: {
                        trigger: item,
                        containerAnimation: horizontalTween, // Vinculado directamente al timeline horizontal
                        start: "left right",
                        end: "right left",
                        scrub: true
                    }
            ...
            // Los PNG flotantes se desplazan a mayor velocidad para salirse del recuadro
            if(floatPng) {
            ...
            // Flotación constante de las auras de color
            if(glowBg) {
                gsap.to(glowBg, {
                    y: "+=25",
                    scale: 1.08,
